    ...
    return (
        <Stack>
            ...
            <Stack p={!isMobile ? 9 : 5} spacing={!isMobile ? 12 : 6}>
                <Stack direction={!isMobile ? 'row' : 'column'} spacing={!isMobile ? 6 : 3} sx={{ boxShadow: '0px 2px 10px 1px rgba(187, 222, 251, 0.81)', borderRadius: 2, }}>
                    <Stack sx={{ boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, padding: 3 }} >
                        <img src={imgs2} alt='project photos' style={!isMobile ? { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '322px', height: '222px' } : { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '100%', height: '152px', }} />
                ...
                <Stack direction={!isMobile ? 'row' : 'column'} spacing={!isMobile ? 6 : 3} sx={{ boxShadow: '0px 2px 10px 1px rgba(187, 222, 251, 0.81)', borderRadius: 2, }}>
                    <Stack sx={{ boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, padding: 3 }} >
                        <img src={imgs3} alt='project photos' style={!isMobile ? { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '322px', height: '222px' } : { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '100%', height: '152px', }} />
                        <Typography sx={{ paddingTop: 2, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                ...
                <Stack direction={!isMobile ? 'row' : 'column'} spacing={!isMobile ? 6 : 3} sx={{ boxShadow: '0px 2px 10px 1px rgba(187, 222, 251, 0.81)', borderRadius: 2, }}>
                    <Stack sx={{ boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, padding: 3 }} >
                        <img src={imgs4} alt='project photos' style={!isMobile ? { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '322px', height: '222px' } : { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '100%', height: '152px', }} />
                        <Typography sx={{ paddingTop: 2, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                ...
                <Stack direction={!isMobile ? 'row' : 'column'} spacing={!isMobile ? 6 : 3} sx={{ boxShadow: '0px 2px 10px 1px rgba(187, 222, 251, 0.81)', borderRadius: 2, }}>
                    <Stack sx={{ boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, padding: 3 }} >
                        <img src={imgs5} alt='project photos' style={!isMobile ? { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '322px', height: '222px' } : { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '100%', height: '152px', }} />
                        <Typography sx={{ paddingTop: 2, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                        ...
                        <Stack direction={'row'} sx={{ justifyContent: 'space-between', paddingTop: 1.2 }}>
                            ...
                            <Button style={{ backgroundColor: '#3a86ff', color: "#023047" }} href='https://github.com/mess-ale/Mapping_technique' target="_blank">{t("home.projectview")}</Button>
                        </Stack>
                    </Stack>
                ...
                <Stack direction={!isMobile ? 'row' : 'column'} spacing={!isMobile ? 6 : 3} sx={{ boxShadow: '0px 2px 10px 1px rgba(187, 222, 251, 0.81)', borderRadius: 2, }}>
                    <Stack sx={{ boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, padding: 3 }} >
                        <img src={imgs6} alt='project photos' style={!isMobile ? { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '322px', height: '222px' } : { boxShadow: '0px 2px 10px 1px rgba(71, 71, 71, 0.51)', borderRadius: 2, width: '100%', height: '152px', }} />
                        <Typography sx={{ paddingTop: 2, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                            {t("project.projectname5")}
                        </Typography>
                        <Stack direction={'row'} sx={{ justifyContent: 'space-between', paddingTop: 1.2 }}>
                            <Typography>
                                {t("project.projectname6")}
                            </Typography>
                            <Button style={{ backgroundColor: '#3a86ff', color: "#023047" }} href='https://sites.google.com/view/t27/project-page?authuser=0' target="_blank">{t("home.projectview")}</Button>
                        </Stack>
                    </Stack>
