        ...
        >
          ...
          >
            <Stack sx={!isMobile && { paddingRight: 15 }}>
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/d/d3/Animated-Flag-Ethiopia.gif"
                alt="ethiopian"
                width="42"
              />
            </Stack>
            ...
            <Stack direction={!isMobile ? "row" : "column"}>
              <Button
                style={{ color: value1 === 0 ? "#06d6a0" : "black" }}
                onClick={() => {
                  dispatch(english());
              ...
              <Button
                style={{ color: value1 === 1 ? "#06d6a0" : "black" }}
                onClick={() => {
                  dispatch(amharic());
                  handleChangeLanguage("amh");
                }}
              >
                {t("header.amh")}
              </Button>
